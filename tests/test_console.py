...
class TestHBNBCommand_prompt(unittest.TestCase):
    """class of test of prompt of the HBNBCommand Interpreter"""
...
class TestHBNBCommand_help(unittest.TestCase):
    """class of test for the help msg HBNB command interpreter."""
...
class ConsoleTestCase(unittest.TestCase):
    ...
    def test_error(self):
        ...
        """ test to see if class doesnt exist """
